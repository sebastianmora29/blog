<x-layouts.app :title="__('Etiquetas')">
    ...
    <div class="w-full p-4 bg-[#171717] border border-gray-700 rounded-lg shadow-sm text-white">
        ...
        <form class="w-full" action="{{ route('admin.etiquetas.store') }}" method="POST">
            @csrf
